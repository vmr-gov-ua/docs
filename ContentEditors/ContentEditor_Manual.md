...
У текстовому полі Markdown можна додати підпис до посилань, використовуючи квадратні дужки для тексту посилання, а потім в дужках вказати саме посилання. 
...
або "Реєстрація відкрита за посиланням: [Форма реєстрації](https://forms.gle/9RLkkRPZ23SX9Db58)" 
...
Інші кнопки панелі управління в полі MarkDownBody:
...
8\) ![](assets/media/image22.png) - вставлення цитати (сірий текст, курсив)

9\) ![](assets/media/image23.png) -
вставка гіперпосилання.

![](assets/media/image24.png) - у шаблоні, яке з'явиться, заповнити
інформацію для гіперпосилання.

10\) ![](assets/media/image25.png) - додавання зображення.

11\) ![](assets/media/image26.png) - маркований список
...
15\) ![](assets/media/image31.png) - увімкнути попередній перегляд

16\) ![](assets/media/image32.png) - увімкнути попередній перегляд
пліч-о-пліч

17\) ![](assets/media/image33.png)- повноекранний вигляд
...
Url -- вказати посилання на потрібну сторінку.
...
> При розміщенні посилань на внутрішні сторінки сайту ВМР,
> потрібно вказувати внутрішні посилання. Наприклад:
>
> /departament-osvity-vmr - внутрішнє посилання
> 
> www.facebook.com/Vinnytsia - зовнішнє посилання
