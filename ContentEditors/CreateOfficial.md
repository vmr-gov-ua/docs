...
- Посилання на форми звернення/перегляду відповідей на звернення (при цьому посилання на ці форми брати зі старого сайту vmr.gov.ua: Розділ "Петиції та звернення громадян", посилання на форми "Написати звернення", "Переглянути публічні відповіді" для конкретної посадової особи) 
